...
auto rtype::UpdateGraph::_setupWaitingRoomScene() -> void
{
	_setupScene[constants::WAITING_ROOM] = std::function(
		...
		{
			_scenePlaceholders.try_emplace(constants::WAITING_ROOM, std::vector<Entity> {});
			...
			if (playerList.self == 1)
			{
				...
				std::any_cast<std::vector<Entity>>(_scenePlaceholders[constants::WAITING_ROOM]).push_back(player1);
			}
			else
			{
			...
			{
				auto player2{ _addSpriteToScene(r, components::sprite_t{0.5f, 0.5f, 0, 0, 835, 227, "ressources/you.png"}, components::position_t{1120, 250}, components::direction_t{0, 0}, components::velocity_t{0, 0}, components::drawable_t{true}, components::scene_t{constants::WAITING_ROOM}, components::zaxis_t{9}) };
				...
				std::any_cast<std::vector<Entity>>(_scenePlaceholders[constants::WAITING_ROOM]).push_back(player2);
			}
			else
			{
				auto player2{ _addSpriteToScene(r, components::sprite_t{0.5f, 0.5f, 0, 0, 835, 227, "ressources/player-2-connected.png"}, components::position_t{1120, 250}, components::direction_t{0, 0}, components::velocity_t{0, 0}, components::drawable_t{true}, components::scene_t{constants::WAITING_ROOM}, components::zaxis_t{7}) };
				_graphicalLib->createSprite(player2, r.getComponents<components::sprite_t>()[player2].value().scaleX, r.getComponents<components::sprite_t>()[player2].value().scaleY, r.getComponents<components::sprite_t>()[player2].value().rectX, r.getComponents<components::sprite_t>()[player2].value().rectY, r.getComponents<components::sprite_t>()[player2].value().rectWidth, r.getComponents<components::sprite_t>()[player2].value().rectHeight, r.getComponents<components::sprite_t>()[player2].value().path);
				std::any_cast<std::vector<Entity>>(_scenePlaceholders[constants::WAITING_ROOM]).push_back(player2);
			}
			if (playerList.self == 3)
			{
				...
				std::any_cast<std::vector<Entity>>(_scenePlaceholders[constants::WAITING_ROOM]).push_back(player3);
			}
			else
			{
			...
			{
				auto player4{ _addSpriteToScene(r, components::sprite_t{0.5f, 0.5f, 0, 0, 835, 227, "ressources/you.png"}, components::position_t{1120, 600}, components::direction_t{0, 0}, components::velocity_t{0, 0}, components::drawable_t{true}, components::scene_t{constants::WAITING_ROOM}, components::zaxis_t{9}) };
				...
				std::any_cast<std::vector<Entity>>(_scenePlaceholders[constants::WAITING_ROOM]).push_back(player4);
			}
			else
			{
				auto player4{ _addSpriteToScene(r, components::sprite_t{0.5f, 0.5f, 0, 0, 835, 227, "ressources/player-4-connected.png"}, components::position_t{1120, 600}, components::direction_t{0, 0}, components::velocity_t{0, 0}, components::drawable_t{true}, components::scene_t{constants::WAITING_ROOM}, components::zaxis_t{5}) };
				_graphicalLib->createSprite(player4, r.getComponents<components::sprite_t>()[player4].value().scaleX, r.getComponents<components::sprite_t>()[player4].value().scaleY, r.getComponents<components::sprite_t>()[player4].value().rectX, r.getComponents<components::sprite_t>()[player4].value().rectY, r.getComponents<components::sprite_t>()[player4].value().rectWidth, r.getComponents<components::sprite_t>()[player4].value().rectHeight, r.getComponents<components::sprite_t>()[player4].value().path);
				std::any_cast<std::vector<Entity>>(_scenePlaceholders[constants::WAITING_ROOM]).push_back(player4);
			}
