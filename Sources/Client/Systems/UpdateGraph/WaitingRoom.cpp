...
auto rtype::UpdateGraph::_setupWaitingRoomScene() -> void
{
    _setupScene[rtype::constants::SCENE::WAITING_ROOM] = std::function(
        ...
        {
            auto playerList = r.getComponents<components::playerList_t>()[constants::RESERVED_ID::GRAPH_UPDATE].value();
            if (playerList.self == 1)
            {
                Entity player1 { _addSpriteToScene(r, components::sprite_t{0.5f, 0.5f, 0, 0, 835, 227, "ressources/you.png"}, components::position_t{200, 250}, components::direction_t{0, 0}, components::velocity_t{0, 0}, components::drawable_t{true}, components::scene_t{constants::SCENE::WAITING_ROOM}, components::zaxis_t{9}) };
            ...
            {
                Entity player1 { _addSpriteToScene(r, components::sprite_t{0.5f, 0.5f, 0, 0, 835, 227, "ressources/player-1-connected.png"}, components::position_t{200, 250}, components::direction_t{0, 0}, components::velocity_t{0, 0}, components::drawable_t{false}, components::scene_t{constants::SCENE::WAITING_ROOM}, components::zaxis_t{8}) };
                _graphicalLib->createSprite(player1, r.getComponents<components::sprite_t>()[player1].value().scaleX, r.getComponents<components::sprite_t>()[player1].value().scaleY, r.getComponents<components::sprite_t>()[player1].value().rectX, r.getComponents<components::sprite_t>()[player1].value().rectY, r.getComponents<components::sprite_t>()[player1].value().rectWidth, r.getComponents<components::sprite_t>()[player1].value().rectHeight, r.getComponents<components::sprite_t>()[player1].value().path);
            }
            if (playerList.self == 2)
            {
                Entity player2 { _addSpriteToScene(r, components::sprite_t{0.5f, 0.5f, 0, 0, 835, 227, "ressources/you.png"}, components::position_t{1520, 250}, components::direction_t{0, 0}, components::velocity_t{0, 0}, components::drawable_t{true}, components::scene_t{constants::SCENE::WAITING_ROOM}, components::zaxis_t{9}) };
            ...
            {
                Entity player2 { _addSpriteToScene(r, components::sprite_t{0.5f, 0.5f, 0, 0, 835, 227, "ressources/player-2-connected.png"}, components::position_t{1520, 250}, components::direction_t{0, 0}, components::velocity_t{0, 0}, components::drawable_t{false}, components::scene_t{constants::SCENE::WAITING_ROOM}, components::zaxis_t{7}) };
                _graphicalLib->createSprite(player2, r.getComponents<components::sprite_t>()[player2].value().scaleX, r.getComponents<components::sprite_t>()[player2].value().scaleY, r.getComponents<components::sprite_t>()[player2].value().rectX, r.getComponents<components::sprite_t>()[player2].value().rectY, r.getComponents<components::sprite_t>()[player2].value().rectWidth, r.getComponents<components::sprite_t>()[player2].value().rectHeight, r.getComponents<components::sprite_t>()[player2].value().path);
            }
            if (playerList.self == 3)
            {
                Entity player3 { _addSpriteToScene(r, components::sprite_t{0.5f, 0.5f, 0, 0, 835, 227, "ressources/you.png"}, components::position_t{200, 600}, components::direction_t{0, 0}, components::velocity_t{0, 0}, components::drawable_t{true}, components::scene_t{constants::SCENE::WAITING_ROOM}, components::zaxis_t{9}) };
            ...
            {
                Entity player3 { _addSpriteToScene(r, components::sprite_t{0.5f, 0.5f, 0, 0, 835, 227, "ressources/player-3-connected.png"}, components::position_t{200, 600}, components::direction_t{0, 0}, components::velocity_t{0, 0}, components::drawable_t{false}, components::scene_t{constants::SCENE::WAITING_ROOM}, components::zaxis_t{6}) };
                _graphicalLib->createSprite(player3, r.getComponents<components::sprite_t>()[player3].value().scaleX, r.getComponents<components::sprite_t>()[player3].value().scaleY, r.getComponents<components::sprite_t>()[player3].value().rectX, r.getComponents<components::sprite_t>()[player3].value().rectY, r.getComponents<components::sprite_t>()[player3].value().rectWidth, r.getComponents<components::sprite_t>()[player3].value().rectHeight, r.getComponents<components::sprite_t>()[player3].value().path);
            }
            if (playerList.self == 4)
            {
                Entity player4 { _addSpriteToScene(r, components::sprite_t{0.5f, 0.5f, 0, 0, 835, 227, "ressources/you.png"}, components::position_t{1520, 600}, components::direction_t{0, 0}, components::velocity_t{0, 0}, components::drawable_t{true}, components::scene_t{constants::SCENE::WAITING_ROOM}, components::zaxis_t{9}) };
            ...
            {
                Entity player4 { _addSpriteToScene(r, components::sprite_t{0.5f, 0.5f, 0, 0, 835, 227, "ressources/player-4-connected.png"}, components::position_t{1520, 600}, components::direction_t{0, 0}, components::velocity_t{0, 0}, components::drawable_t{false}, components::scene_t{constants::SCENE::WAITING_ROOM}, components::zaxis_t{5}) };
                _graphicalLib->createSprite(player4, r.getComponents<components::sprite_t>()[player4].value().scaleX, r.getComponents<components::sprite_t>()[player4].value().scaleY, r.getComponents<components::sprite_t>()[player4].value().rectX, r.getComponents<components::sprite_t>()[player4].value().rectY, r.getComponents<components::sprite_t>()[player4].value().rectWidth, r.getComponents<components::sprite_t>()[player4].value().rectHeight, r.getComponents<components::sprite_t>()[player4].value().path);
            }
            Entity backgroundId { _addSpriteToScene(r, components::sprite_t{0.9f, 0.9f, 0, 0, 1920, 1080, "ressources/MainMenu.jpg"}, components::position_t{0, 0}, components::direction_t{0, 0}, components::velocity_t{0, 0}, components::drawable_t{true}, components::scene_t{constants::SCENE::WAITING_ROOM}, components::zaxis_t{10}) };
...
auto rtype::UpdateGraph::_setupExecWaitingRoomScene() -> void
{
    _execScene[rtype::constants::SCENE::WAITING_ROOM] = std::function(
        [this](Registry &r, SparseArray<components::currentScene_t> &currentScenes) -> void
        {
            ...
            auto& time = r.getComponents<components::myTime_t>()[constants::RESERVED_ID::TIME_UPDATE];
            dtime += time.value().deltaTime;
            std::vector<size_t> savedIdx {};
            auto &playerList = r.getComponents<components::playerList_t>()[constants::RESERVED_ID::GRAPH_UPDATE];
            ...
            for (auto &&[pos, sprite, scene, drawable, index, zaxis] : Zipper(r.getComponents<components::position_t>(), r.getComponents<components::sprite_t>(), r.getComponents<components::scene_t>(), r.getComponents<components::drawable_t>(), r.getComponents<components::index_t>(), r.getComponents<components::zaxis_t>()))
            {
                ...
                zAxisMap[static_cast<int>(zaxis.zAxis)] = std::pair(index.idx, constants::TYPE::SPRITE);
            ...
            if (dtime.count() > 1500000000) {
                net.value().sendRequest.push_back(std::vector<uint8_t>{22, (uint8_t)(r.getComponents<components::currentRoom_t>()[constants::RESERVED_ID::GRAPH_UPDATE].value().id)});
                dtime = std::chrono::nanoseconds(0);
            }
            if (playerList.value().players == 4)
            {
                r.getComponents<components::currentScene_t>()[constants::RESERVED_ID::GRAPH_UPDATE].value().isLoaded = false;
                r.getComponents<components::currentScene_t>()[constants::RESERVED_ID::GRAPH_UPDATE].value().scene = constants::SCENE::LOADING_MENU;
            }
        });
}
