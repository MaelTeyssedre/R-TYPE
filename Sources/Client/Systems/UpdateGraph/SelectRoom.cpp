...
auto rtype::UpdateGraph::_setupSelectRoomScene() -> void
{
    _setupScene[rtype::constants::SELECT_ROOM] = std::function(
        ...
        {
            auto roomList{ r.getComponents<components::roomList_t>()[constants::RESERVED_ID::GRAPH_UPDATE].value() };
            Entity room1Id{ _addButtonToScene(r, components::sprite_t{0.5f, 0.5f, 0, 0, 800, 215, BUTTON_1_SELECT_ROOM}, components::position_t{ WINDOW_SIZE_X * 0.1, WINDOW_SIZE_Y * 0.5 }, components::direction_t{ 0, 0 }, components::velocity_t{ 0, 0 }, components::drawable_t{ true }, components::scene_t{ constants::SCENE::SELECT_ROOM }, components::zaxis_t{ 9 }, components::clickable_t{ false, false, [this](Registry& r, size_t id) -> void { r.getComponents<components::sprite_t>()[id].value().rectY = 215; }, [this](Registry& r, size_t id) -> void { r.getComponents<components::sprite_t>()[id].value().rectY = 0; r.getComponents<components::network_s>()[constants::RESERVED_ID::NETWORK_UPDATE].value().sendRequest.push_back(std::vector<uint8_t>{19, 1}); r.getComponents<components::currentRoom_t>()[constants::RESERVED_ID::GRAPH_UPDATE].value().id = 1; }}, components::mouseState_s {0, 0, false, false}, components::mySize_t {400, 215}) };
            ...
            Entity room2Id{ _addButtonToScene(r, components::sprite_t{ 0.5f, 0.5f, 0, 0, 800, 215, BUTTON_2_SELECT_ROOM }, components::position_t{ WINDOW_SIZE_X * 0.1, WINDOW_SIZE_Y * 0.8 }, components::direction_t{ 0, 0 }, components::velocity_t{ 0, 0 }, components::drawable_t{ true }, components::scene_t{ constants::SCENE::SELECT_ROOM }, components::zaxis_t{ 8 }, components::clickable_t{ false, false, [this](Registry& r, size_t id) -> void { r.getComponents<components::sprite_t>()[id].value().rectY = 215; }, [this](Registry& r, size_t id) -> void { r.getComponents<components::sprite_t>()[id].value().rectY = 0; r.getComponents<components::network_t>()[constants::RESERVED_ID::NETWORK_UPDATE].value().sendRequest.push_back(std::vector<uint8_t>{19, 2}); r.getComponents<components::currentRoom_t>()[constants::RESERVED_ID::GRAPH_UPDATE].value().id = 2; }}, components::mouseState_s {0, 0, false, false}, components::mySize_t {400, 215}) };
            ...
            Entity room3Id{ _addButtonToScene(r, components::sprite_t{0.5f, 0.5f, 0, 0, 800, 215, BUTTON_3_SELECT_ROOM }, components::position_t{ static_cast<float>((WINDOW_SIZE_X * 0.4)), WINDOW_SIZE_Y * 0.65 }, components::direction_t{ 0, 0 }, components::velocity_t{ 0, 0 }, components::drawable_t{ true }, components::scene_t{ constants::SCENE::SELECT_ROOM }, components::zaxis_t{ 3 }, components::clickable_t{ false, false, [this](Registry& r, size_t id) -> void { r.getComponents<components::sprite_t>()[id].value().rectY = 215; }, [this](Registry& r, size_t id) -> void { r.getComponents<components::sprite_t>()[id].value().rectY = 0; r.getComponents<components::network_s>()[constants::RESERVED_ID::NETWORK_UPDATE].value().sendRequest.push_back(std::vector<uint8_t>{19, 3}); r.getComponents<components::currentRoom_s>()[constants::RESERVED_ID::GRAPH_UPDATE].value().id = 3; }}, components::mouseState_t {0, 0, false, false},components::mySize_t {400, 215}) };
            ...
            Entity room4Id { _addButtonToScene(r, components::sprite_t{0.5f, 0.5f, 0, 0, 800, 215, BUTTON_4_SELECT_ROOM }, components::position_t{ WINDOW_SIZE_X * 0.7, WINDOW_SIZE_Y * 0.5 }, components::direction_t{ 0, 0 }, components::velocity_t{ 0, 0 }, components::drawable_t{ true }, components::scene_t{ constants::SCENE::SELECT_ROOM }, components::zaxis_t{ 6 }, components::clickable_t{  false, false, [this](Registry &r, size_t id) -> void { r.getComponents<components::sprite_t>()[id].value().rectY = 215; }, [this](Registry &r, size_t id) -> void{ r.getComponents<components::sprite_t>()[id].value().rectY = 0; r.getComponents<components::network_t>()[constants::RESERVED_ID::NETWORK_UPDATE].value().sendRequest.push_back(std::vector<uint8_t>{19, 4}); r.getComponents<components::currentRoom_t>()[constants::RESERVED_ID::GRAPH_UPDATE].value().id = 4; }}, components::mouseState_t { 0, 0, false, false }, components::mySize_t {400, 215}) };
            ...
            Entity room5Id{ _addButtonToScene(r, components::sprite_t{ 0.5f, 0.5f, 0, 0, 800, 215, BUTTON_5_SELECT_ROOM  }, components::position_t{  WINDOW_SIZE_X * 0.7, WINDOW_SIZE_Y * 0.8 }, components::direction_t{ 0, 0 }, components::velocity_t{ 0, 0 }, components::drawable_t{ true }, components::scene_t{ constants::SCENE::SELECT_ROOM }, components::zaxis_t{ 5 }, components::clickable_t{ false, false, [this](Registry& r, size_t id) -> void { r.getComponents<components::sprite_t>()[id].value().rectY = 215; }, [this](Registry& r, size_t id) -> void { r.getComponents<components::sprite_t>()[id].value().rectY = 0; r.getComponents<components::network_t>()[constants::RESERVED_ID::NETWORK_UPDATE].value().sendRequest.push_back(std::vector<uint8_t>{19, 5}); r.getComponents<components::currentRoom_t>()[constants::RESERVED_ID::GRAPH_UPDATE].value().id = 5; }}, components::mouseState_s {0, 0, false, false}, components::mySize_t {400, 215}) };
            ...
            {
                Entity logoId{ _addSpriteToScene(r, components::sprite_t{ static_cast<float>(0.9), static_cast<float>(0.9), 0, 0, 663, 369, "ressources/NoRoom.png" }, components::position_t{ (WINDOW_SIZE_X / 2) - ((663) / 2), 150 }, components::direction_t{ 0, 0 }, components::velocity_t{ 0, 0 }, components::drawable_t{ true }, components::scene_t{ constants::SCENE::SELECT_ROOM }, components::zaxis_t{ 7 }) };
            ...
            _scenePlaceholders.try_emplace(constants::SCENE::SELECT_ROOM, std::vector<Entity> {room1Id, room2Id, room3Id, room4Id, room5Id});
        });
}
...
auto rtype::UpdateGraph::_setupExecSelectRoomScene() -> void
{
    _execScene[rtype::constants::SELECT_ROOM] = std::function(
        [this](Registry& r, SparseArray<components::currentScene_t>& currentScenes) -> void
        {
            std::vector<Entity> localEntities = std::any_cast<std::vector<Entity>>(_scenePlaceholders[rtype::constants::SELECT_ROOM]);
            ...
            if (!(net.value().request17.empty()) && !(net.value().request17.front().empty()))
            {
                ...
                auto &drawableRoom2 = r.getComponents<components::drawable_t>();
