		...
		[this](Registry& r, SparseArray<components::currentScene_t>& currentScenes) -> void
		{
			...
			auto room1Id{ _addButtonToScene(r, components::sprite_t{0.5f, 0.5f, 0, 0, 800, 215, BUTTON_1_SELECT_ROOM}, components::position_t{ WINDOW_SIZE_X * 0.1, WINDOW_SIZE_Y * 0.5 }, components::direction_t{ 0, 0 }, components::velocity_t{ 0, 0 }, components::drawable_t{ true }, components::scene_t{ constants::SELECT_ROOM }, components::zaxis_t{ 9 }, components::clickable_t{ false, false,
				...
				[this](Registry& r, size_t id) -> void {
					...
					r.getComponents<components::network_t>()[constants::NETWORK_UPDATE].value().sendRequest.push_back(std::vector<uint8_t>{19, 1});
					r.getComponents<components::currentRoom_t>()[constants::GRAPH_UPDATE].value().id = 1;
			...
			auto room2Id{ _addButtonToScene(r, components::sprite_t{ 0.5f, 0.5f, 0, 0, 800, 215, BUTTON_2_SELECT_ROOM }, components::position_t{ WINDOW_SIZE_X * 0.1, WINDOW_SIZE_Y * 0.8 }, components::direction_t{ 0, 0 }, components::velocity_t{ 0, 0 }, components::drawable_t{ true }, components::scene_t{ constants::SELECT_ROOM }, components::zaxis_t{ 8 }, components::clickable_t{ false, false,
				...
				[this](Registry& r, size_t id) -> void {
					...
					r.getComponents<components::currentRoom_t>()[constants::GRAPH_UPDATE].value().id = 2;
				}}, components::mouseState_s {0, 0, false, false}, components::mySize_t {400, 215}) };
			...
			auto room3Id{ _addButtonToScene(r, components::sprite_t{0.5f, 0.5f, 0, 0, 800, 215, BUTTON_3_SELECT_ROOM }, components::position_t{ static_cast<float>((WINDOW_SIZE_X * 0.4)), WINDOW_SIZE_Y * 0.65 }, components::direction_t{ 0, 0 }, components::velocity_t{ 0, 0 }, components::drawable_t{ true }, components::scene_t{ constants::SELECT_ROOM }, components::zaxis_t{ 3 }, components::clickable_t{ false, false,
				[this](Registry& r, size_t id) -> void {
					if (!r.getComponents<components::drawable_t>()[id].value().drawable)
						return;
					r.getComponents<components::sprite_t>()[id].value().rectY = 215;
				...
				[this](Registry& r, size_t id) -> void {
					...
					r.getComponents<components::currentRoom_t>()[constants::GRAPH_UPDATE].value().id = 3;
			...
			auto room4Id{ _addButtonToScene(r, components::sprite_t{0.5f, 0.5f, 0, 0, 800, 215, BUTTON_4_SELECT_ROOM }, components::position_t{ WINDOW_SIZE_X * 0.7, WINDOW_SIZE_Y * 0.5 }, components::direction_t{ 0, 0 }, components::velocity_t{ 0, 0 }, components::drawable_t{ true }, components::scene_t{ constants::SELECT_ROOM }, components::zaxis_t{ 6 }, components::clickable_t{  false, false,
				[this](Registry& r, size_t id) -> void {
					if (!r.getComponents<components::drawable_t>()[id].value().drawable)
						return;
					r.getComponents<components::sprite_t>()[id].value().rectY = 215;
				...
				[this](Registry& r, size_t id) -> void {
					...
					r.getComponents<components::currentRoom_t>()[constants::GRAPH_UPDATE].value().id = 4;
				}}, components::mouseState_t { 0, 0, false, false }, components::mySize_t {400, 215}) };
			...
			{
				auto logoId{ _addSpriteToScene(r, components::sprite_t{ 0.9f, 0.9f, 0, 0, 663, 369, "ressources/NoRoom.png" }, components::position_t{ (WINDOW_SIZE_X / 2) - ((663) / 2), 150 }, components::direction_t{ 0, 0 }, components::velocity_t{ 0, 0 }, components::drawable_t{ true }, components::scene_t{ constants::SELECT_ROOM }, components::zaxis_t{ 7 }) };
			...
			{
				auto logoId{ _addSpriteToScene(r, components::sprite_t{ 0.9f, 0.9f, 0, 0, 663, 369, "ressources/logo.png" }, components::position_t{ (WINDOW_SIZE_X / 2) - ((663) / 2), 150 }, components::direction_t{ 0, 0 }, components::velocity_t{ 0, 0 }, components::drawable_t{ true }, components::scene_t{ constants::SELECT_ROOM }, components::zaxis_t{ 7 }) };
				_graphicalLib->createSprite(logoId, r.getComponents<components::sprite_t>()[logoId].value().scaleX, r.getComponents<components::sprite_t>()[logoId].value().scaleY, r.getComponents<components::sprite_t>()[logoId].value().rectX, r.getComponents<components::sprite_t>()[logoId].value().rectY, r.getComponents<components::sprite_t>()[logoId].value().rectWidth, r.getComponents<components::sprite_t>()[logoId].value().rectHeight, r.getComponents<components::sprite_t>()[logoId].value().path);
			}
			auto backgroundId{ _addSpriteToScene(r, components::sprite_t{ 0.9f, 0.9f, 0, 0, 1920, 1080, "ressources/MainMenu.jpg" }, components::position_t{ 0, 0 }, components::direction_t{ 0, 0 }, components::velocity_t{ 0, 0 }, components::drawable_t{ true }, components::scene_t{ constants::SELECT_ROOM }, components::zaxis_t{ 10 }) };
