...
auto rtype::UpdateGraph::_createTransitionSelectRoom(Registry &r) -> Entity
{
    Entity id = r.spawnEntity();
...
auto rtype::UpdateGraph::_createSelectRoom1ButtonSelectRoom(Registry &r) -> Entity
{
    ...
    struct components::clickable_s clickable = {
        ...
        [this](Registry &r, size_t id) -> void
        {
            ...
            r.getComponents<components::network_s>()[constants::RESERVED_ID::NETWORK_UPDATE].value().sendRequest.push_back(std::vector<uint8_t>{1});
        }};
    struct components::position_s pos = {350, (WINDOW_SIZE_Y / 2)};
    struct components::direction_s dir = {0, 0};
    struct components::velocity_s vel = {0, 0};
    struct components::drawable_s drawable = {true};
...
auto rtype::UpdateGraph::_createSelectRoom2ButtonSelectRoom(Registry &r) -> Entity
{
    ...
    struct components::clickable_s clickable = {
        ...
        [this](Registry &r, size_t id) -> void
        {
            r.getComponents<components::sprite_s>()[id].value().rectY = 0;
            r.getComponents<components::network_s>()[constants::RESERVED_ID::NETWORK_UPDATE].value().sendRequest.push_back(std::vector<uint8_t>{19});
            r.getComponents<components::network_s>()[constants::RESERVED_ID::NETWORK_UPDATE].value().sendRequest.push_back(std::vector<uint8_t>{2});
        }};
    struct components::position_s pos = {1170, (WINDOW_SIZE_Y / 2)};
    struct components::direction_s dir = {0, 0};
    struct components::velocity_s vel = {0, 0};
    struct components::drawable_s drawable = {true};
    struct components::mouseState_s mouse = {0, 0, false, false};
...
auto rtype::UpdateGraph::_createSelectRoom3ButtonSelectRoom(Registry &r) -> Entity
{
    ...
    struct components::clickable_s clickable = {
        ...
        [this](Registry &r, size_t id) -> void
        {
            r.getComponents<components::sprite_s>()[id].value().rectY = 0;
            r.getComponents<components::network_s>()[constants::RESERVED_ID::NETWORK_UPDATE].value().sendRequest.push_back(std::vector<uint8_t>{19});
            r.getComponents<components::network_s>()[constants::RESERVED_ID::NETWORK_UPDATE].value().sendRequest.push_back(std::vector<uint8_t>{3});
        }};
    struct components::position_s pos = {200, (WINDOW_SIZE_Y / 2) + 250};
    struct components::direction_s dir = {0, 0};
    struct components::velocity_s vel = {0, 0};
    struct components::drawable_s drawable = {true};
    struct components::mouseState_s mouse = {0, 0, false, false};
...
auto rtype::UpdateGraph::_createSelectRoom4ButtonSelectRoom(Registry &r) -> Entity
{
    ...
    struct components::clickable_s clickable = {
        ...
        [this](Registry &r, size_t id) -> void
        {
            r.getComponents<components::sprite_s>()[id].value().rectY = 0;
            r.getComponents<components::network_s>()[constants::RESERVED_ID::NETWORK_UPDATE].value().sendRequest.push_back(std::vector<uint8_t>{19});
            r.getComponents<components::network_s>()[constants::RESERVED_ID::NETWORK_UPDATE].value().sendRequest.push_back(std::vector<uint8_t>{4});
        }};
    struct components::position_s pos = {(WINDOW_SIZE_X / 2) - ((400) / 2), (WINDOW_SIZE_Y / 2) + 250};
    struct components::direction_s dir = {0, 0};
    struct components::velocity_s vel = {0, 0};
    struct components::drawable_s drawable = {true};
    struct components::mouseState_s mouse = {0, 0, false, false};
...
auto rtype::UpdateGraph::_createSelectRoom5ButtonSelectRoom(Registry &r) -> Entity
{
    ...
    struct components::position_s pos = {1320, (WINDOW_SIZE_Y / 2) + 250};
    struct components::direction_s dir = {0, 0};
    struct components::velocity_s vel = {0, 0};
    struct components::drawable_s drawable = {true};
    struct components::mouseState_s mouse = {0, 0, false, false};
