    ...
    namespace rtype {
        ...
        class UpdatePosition {
            public:
                ...
                /**
                 * \fn auto operator()(Registry &r, SparseArray<components::position_s> &positions, SparseArray<components::direction_s> &directions, SparseArray<components::velocity_s> &velocities) -> void
                 *
