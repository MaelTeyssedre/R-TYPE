...
{
	return (mouse_t{ _mouse.getPosition(*_renderWindow).x, _mouse.getPosition(*_renderWindow).y, sf::Mouse::isButtonPressed(sf::Mouse::Left), sf::Mouse::isButtonPressed(sf::Mouse::Right) });
}
